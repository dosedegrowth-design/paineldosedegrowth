...
import { listBirthdays } from "@/lib/queries/admin";
import { getSettings } from "@/lib/settings";
import { getPublicBenefits } from "@/lib/queries/catalog";
import { ROUTES } from "@/lib/config";
import { dateShort, dayMonth, monthName } from "@/lib/format";
import { whatsappUrl } from "@/lib/whatsapp";
import { AdminBlock, AdminHeader, Empty } from "@/components/admin/shell";
import { ReleaseBirthdayForm } from "@/components/admin/forms";
import { BenefitStatusText, StatusText } from "@/components/ui/status";
