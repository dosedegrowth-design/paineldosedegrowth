        ...
        <ul className="grid grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-4">
          {items.map((it) => (
            <li key={it.title} className="flex items-start gap-3">
              <span className="inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-sky-50 border border-sky-100">
                <it.icon className="h-5 w-5 text-sky-600" />
              </span>
