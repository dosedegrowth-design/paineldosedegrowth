import { Flower2, Instagram, Mail, MessageCircle, Music2 } from "lucide-react";
import { BranchEucalyptus, FlowerSimple } from "./botanicals";
...
export function CarolContato() {
  return (
    <section id="contato" className="relative overflow-hidden bg-[var(--carol-bg-soft)] pb-14 pt-24 md:pt-32">
      ...
      <BranchEucalyptus className="absolute -left-6 bottom-24 h-56 rotate-[14deg] text-[var(--carol-accent)]/18" />
      <FlowerSimple className="absolute right-10 top-24 h-12 w-12 -rotate-12 text-[var(--carol-terra)]/25" />
      ...
      <div className="relative mx-auto max-w-4xl px-5 text-center md:px-8">
        ...
        <Reveal delay={0.18}>
          <p className="mt-8 flex items-center justify-center gap-2 text-[13px] text-[var(--carol-muted)]">
            <Flower2 className="h-4 w-4 text-[var(--carol-accent)]" />
            Mulher querendo entrar na comunidade?{" "}
            <a
          ...
          <p className="mt-3 text-[13px] text-[var(--carol-muted)]">
