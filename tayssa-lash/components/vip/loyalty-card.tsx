...
import type { RevealResult } from "@/lib/actions/card";
import type { CardStamp } from "@/lib/types";
import { ScratchSheet } from "@/components/vip/scratch-sheet";
import { useFinePointer } from "@/components/ui/use-media";
